 ...
 */
public class HomeDataAdapter extends RecyclerView.Adapter<HomeDataAdapter.HomeHolder> {

    private List<FruitInfo> mFruitInfoList;
    private Context mContext;

    public HomeDataAdapter(Context context, List<FruitInfo> fruitInfoList) {
