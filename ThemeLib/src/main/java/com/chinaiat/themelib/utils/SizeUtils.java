...
public class SizeUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = ThemeLibApplication.context.getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        final float fontScale =  ThemeLibApplication.context.getResources().getDisplayMetrics().scaledDensity;
