package com.chinaiat.themelib.helper;
...
public final class SPHelper {
    ...
    public static void setTheme(int index) {
        SharedPreferences sharedPreferences = ThemeLibApplication.context.getSharedPreferences(CHANGE_THEME, Context.MODE_PRIVATE);
